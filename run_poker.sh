#!/bin/bash
# Script para executar o poker_gui.py usando o Python do sistema
...
echo "PIL/Pillow do sistema: $(/usr/bin/python3 -c 'import PIL; print(PIL.__version__)')"
echo "==============================="
echo ""

# Executa o poker_gui.py usando o Python do sistema
echo "Executando poker_gui.py com o Python do sistema..."
/usr/bin/python3 poker_gui.py