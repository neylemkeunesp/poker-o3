...
class PokerGUI:
    ...
    def setup_frames(self):
        ...
        # Definir altura máxima para o painel de informações
        self.info_panel_frame.config(height=200)  # Limitar altura para garantir que os botões apareçam
        ...
        self.info_notebook.add(self.chips_frame, text="Chips e Apostas")
        ...
        self.action_history_canvas = tk.Canvas(
            ...
            height=150  # Limitar altura do canvas
        )
    ...
    def update_chips_display(self):
        """Atualiza a visualização de chips na aba de Chips e Apostas"""
        # Atualizar valores de chips
